...
export default function LoginPage() {
  ...
  return (
    <main className="flex-1 flex items-center justify-center px-4 py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-80 h-80 bg-lime-dark/15 rounded-full blur-3xl pointer-events-none animate-float" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-forest/20 rounded-full blur-3xl pointer-events-none animate-float [animation-delay:2s]" />
      <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-navy-light/10 rounded-full blur-2xl pointer-events-none animate-float [animation-delay:1s]" />
        ...
        <div className="relative p-[1.5px] overflow-hidden rounded-[24px] shadow-[0_20px_50px_rgba(31,35,47,0.35)] bg-forest/10 backdrop-blur-xl group hover:shadow-[0_20px_50px_rgba(214,231,82,0.15)] transition-all duration-300">
          ...
          <div className="relative z-10 bg-navy/95 rounded-[22.5px] p-8 sm:p-10 text-white flex flex-col">
            ...
            <div className="text-center mb-8">
              <Link href="/" className="inline-flex items-center gap-2.5 mb-5 hover:scale-[1.02] transition-transform duration-200">
